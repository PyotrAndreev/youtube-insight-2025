...
4. **Анализ тональности** 
   - Потребитель увидит, какой процент комментариев положительный, нейтральный или отрицательный, что поможет оценить общее настроение аудитории. оформи для readme.md, не изменяя слов
